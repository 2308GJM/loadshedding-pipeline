...
# Separate env var from load-shedding's raw data dir — sharing one
# RAW_DATA_DIR name across both ingestion modules caused a silent path
# collision where weather data landed inside the load-shedding folder.
